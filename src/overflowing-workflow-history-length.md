...
See also: [Not using ContinueAsNew](not_using_continue_as_new/README.md), [Overflowing workflow history bytes](overflowing-workflow-history-bytes.md).

<!-- TODO: Add code example/link to existing code example for ShouldContinueAsNew -->
