...
[assuming_activity_cancelation_means_workflow_cancelation/activity.go](https://github.com/jlegrone/100-temporal-mistakes/blob/main/assuming_activity_cancelation_means_workflow_cancelation/activity.go)
```go
