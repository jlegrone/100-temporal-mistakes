...
[starting_workflows_from_activities/examples.go](https://github.com/jlegrone/100-temporal-mistakes/blob/main/starting_workflows_from_activities/examples.go)
```go
