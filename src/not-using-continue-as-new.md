...
> [!TIP]
> Long-running workflows accumulate events in their history, leading to longer [replay](terms/replay.md) times and eventually hitting the [history size limit](overflowing-workflow-history-size.md). [ContinueAsNew](terms/continue-as-new.md) resets the history and also limits the age of your code, simplifying [versioning](terms/versioning.md).
